...
./BuildSources.sh "$BUILD_CONFIG" "$PROJECT_DIR" "$INPUT_DIR"
checkError
...
"$path/./lua" -e "package.path=package.path..';$path/../resources/?.lua'" -e "package.cpath=package.cpath..';$path/./lfs.so'" "$path/create_build_properties.lua" "$TMP_DIR" com.ansca.test.Corona "$PROJ_DIR" 1 1.0
checkError
