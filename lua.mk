...
$(OutputFile): $(Objects)
	...
	@echo rebuilt > "/home/vitaly/main/platform/linux/.build-release/lua"
...
$(IntermediateDirectory)/up_up_external_lua-5.1.3_src_lua.c$(ObjectSuffix): ../../external/lua-5.1.3/src/lua.c $(IntermediateDirectory)/up_up_external_lua-5.1.3_src_lua.c$(DependSuffix)
	$(CC) $(SourceSwitch) "/home/vitaly/main/external/lua-5.1.3/src/lua.c" $(CFLAGS) $(ObjectSwitch)$(IntermediateDirectory)/up_up_external_lua-5.1.3_src_lua.c$(ObjectSuffix) $(IncludePath)
